...
#| tbl-cap: |
#|   Criteria to operationalize replication success [adapted from @HeyardEtAl2025 [Table 4]]
...
names(rs)[names(rs) == "Type of Reproducibility investigated"] <- "Type of Repeatability investigated"
...
![Interpretation of replication outcomes depends on the similarity/closeness between studies and the results, as well as whether an inductive or deductive view is adopted (see @sec-types-replication for the conceptual framework).](images/eH3_Image_5.png){#fig-success-interpretation}
