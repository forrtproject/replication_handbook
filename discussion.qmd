...
#|   *Note*. For full references and descriptions, see the original table, also available [online](http://rachelheyard.com/reproducibility_metrics/#table). Reused in accordance with the CC-BY license of the published article.
#| echo: false
#| message: false
#| warning: false
...
![Interpretation of replication outcomes depend on similarity of **closeness** and results as well as the view (**inductive vs. deductive**).](images/eH3_Image_5.png){#fig-success-interpretation}
