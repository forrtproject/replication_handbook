...
#### Defining and Determining Replication Success
...
*Note*. For reference and descriptions see the full table by @HeyardEtAl2025 [Table 4] also available [online]( http://rachelheyard.com/reproducibility_metrics/#table). Reused in accordance with the CC-BY license of the published article and the [OSF-project](https://osf.io/sbcy3)
...
#### The Role of Differences for the Interpretation of Findings
...
![Guidelines for how repliccation outcomes should be interpreted based on similarity of original and replication](images/eH3_Image_5.png)
