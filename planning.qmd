...
![Decision tree to choose between types of reproductions depending on available code and data.](images/WBn_Image_3.png){#fig-repr-decision-tree}{.lightbox}
...
![Sequence of replications from exact replications to conceptual replications under field conditions](images/6sH_Image_4.png){#fig-replication-sequence}{.lightbox}
